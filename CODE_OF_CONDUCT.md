...
[GitHub private vulnerability reporting](https://github.com/frappeforge/frappeforge/security/advisories/new)
(marked "Code of Conduct") or by direct message to a maintainer listed in
[CODEOWNERS](.github/CODEOWNERS). All complaints will be reviewed and investigated promptly
and fairly.
...
1. **Correction** — a private, written warning, with an explanation of why the behavior was
